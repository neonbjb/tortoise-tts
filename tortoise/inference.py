...
def infer_on_texts(call_tts: Callable[[str],Any], texts: List[str], output_dir: Union[str,Path], return_deterministic_state: bool, lines_to_regen: Set[int], logger=print, return_filepath=False):
    audio_parts = []
