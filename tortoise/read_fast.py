...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_name",
        type=str,
        help="How to name the output file",
    ...
    parser.add_argument(
        "--use_deepspeed",
        type=bool,
        help="Use deepspeed for speed bump.",
        default=False,
    )
    parser.add_argument(
        "--kv_cache",
    ...
    for selected_voice in selected_voices:
        ...
        for j, text in enumerate(texts):
            ...
            start_time = time()
            gen = tts.tts(
                text, voice_samples=voice_samples, use_deterministic_seed=seed
            )
            end_time = time()
        ...
        torchaudio.save(
            os.path.join(voice_outpath, f"{outname}.wav"), full_audio, 24000
        )
